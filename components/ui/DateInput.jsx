      ...
      <AnimatePresence>
        { isOpen && (
          <motion.div
            ...
            className="absolute left-0 top-[calc(100%+8px)] z-50 w-70 rounded-[18px] border border-apple-hairline bg-apple-canvas p-4 apple-product-shadow"
          >
              ...
              { calendarDays.map( ( { date, outside } ) =>
              {
                ...
                return (
                  <button
                    ...
                    className={ `flex h-9 w-9 items-center justify-center rounded-full text-sm transition-all ${ isSelected
