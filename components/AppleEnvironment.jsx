  ...
  return (
    <div className="w-full bg-apple-canvas text-apple-ink min-h-screen flex flex-col items-center">
      ...
      <section className="w-full bg-apple-surface-tile-1 text-white py-24 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden border-b border-apple-surface-black">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-blue-950/20 via-emerald-950/10 to-apple-surface-tile-1 opacity-60 pointer-events-none" />

        <div className="w-full max-w-200 flex flex-col items-center gap-6 relative z-10">
          ...
          <h1 className="typography-display-lg font-semibold text-white tracking-tight max-w-162.5">
            A plan as ambitious as your day.
          </h1>

          <p className="typography-lead-airy text-apple-body-muted max-w-150 mb-4">
      ...
      <section className="w-full max-w-5xl py-24 px-4 md:px-8 flex flex-col gap-16 text-left">
        ...
        <div className="w-full p-8 md:p-12 rounded-2xl bg-apple-canvas-parchment border border-apple-hairline flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex-1">
            ...
            <p className="typography-caption text-apple-ink-muted-48 max-w-125">
